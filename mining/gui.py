...
class Dashboard(Frame):
    ...
    def __init__(self, master):
        ...
        self.map_button1 = Button(self.master, text="First Map", 
                                  command=lambda: self.create_window("THIS IS DATA"))
        self.map_button1.pack()

        self.map_button2 = Button(self.master, text="Second Map", 
                                  command=lambda: self.create_window("THIS IS alittle bit of DATA"))
        self.map_button2.pack()

        self.map_button3 = Button(self.master, text="Third Map", 
                                  command=lambda: self.create_window("THIS IS SOME DATA!"))
    ...
    """
    def updater(self):
        self.create_window(map_data):
        self.after(0.5, self.updater)
    """   
