#! /usr/bin/env python3
"""
This module provide a dashboard to print out the map representation of the data
the drones have discovered.
"""
...
class Dashboard:
    ...
    def convert_to_string(self, map_id):
        """ Return a string of data and convert graph obj data """

        list_of_keys = list([key for key in
                             self.overlord.graphs[map_id].cells_dict.keys()])
        ...
        try:
            ...
            for y in range(max_y, min_y - 1, -1):
                ...
                for x in range(min_x, max_x + 1):
                    try:
                        """
                        Couldn't fit this line to append symbol
                        in less than 80 Characters to stay clear.
                        """
